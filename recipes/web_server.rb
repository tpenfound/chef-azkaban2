...
cookbook_file "#{install_dir}/#{ws_dir}/conf/log4j.properties" do
...
cookbook_file "#{install_dir}/#{ws_dir}/conf/global.properties" do
...
cookbook_file "#{install_dir}/#{ws_dir}/conf/azkaban-users.xml" do
